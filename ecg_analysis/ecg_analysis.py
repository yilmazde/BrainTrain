...
raw = mne.io.read_raw("BHC014_eyes-closed.vhdr", preload=True)
...
baseline = (-0.25,-0.2)
ecg_epochs = mne.preprocessing.create_ecg_epochs(ecg_data_e, ch_name='ECG', tmin = -0.25, tmax = 0.55, baseline = baseline)

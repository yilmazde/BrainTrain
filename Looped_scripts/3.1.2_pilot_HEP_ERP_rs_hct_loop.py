...
column_names = ['subject_id', 'session', 'task', 'event_type',  'event_times',
...
for participant_no in participant_numbers:
    for session in sessions:
        for task in tasks: 
            ...
            # directory for plots
            plot_dir = '/Users/denizyilmaz/Desktop/BrainTrain/BrainTrain_EEG_data/HEPs/plots/'
            
            # time window to highlight on plot
            highlight = (0.45, 0.50)
            
            hep_joint_plot = heartbeat_evoked.plot_joint(show=False)
            hep_joint_plot_path = os.path.join(plot_dir, f'BTSCZ{participant_no}_{session}_{task}_joint_plot.jpg' )
            ...
            hep_plot_path = os.path.join(plot_dir, f'BTSCZ{participant_no}_{session}_{task}_hep_plot.jpg' )
            hep_plot.savefig(hep_plot_path, format='jpg')
            
            hep_plot_3chans = mne.viz.plot_evoked(heartbeat_evoked, highlight=highlight, picks = ['F4', 'F8', 'Fp2'])
            hep_plot_3chans_path = os.path.join(plot_dir, f'BTSCZ{participant_no}_{session}_{task}_hep_plot_3chans.jpg' )
            hep_plot_3chans.savefig(hep_plot_3chans_path, format='jpg')
            
            hep_psd_plot = heartbeat_evoked.plot_psd()
            hep_psd_plot_path = os.path.join(plot_dir, f'BTSCZ{participant_no}_{session}_{task}_hep_psd_plot.jpg' )
            ...
            average_frontal_central_plot = mne.viz.plot_evoked(average_frontal_central,  highlight=highlight)
            average_frontal_central_plot_path = os.path.join(plot_dir, f'BTSCZ{participant_no}_{session}_{task}_hep_average_frontal_central_plot.jpg' )
            ...
            if task == 'eyes-closed' and session == 'V1':
                mne.write_evokeds('/Users/denizyilmaz/Desktop/BrainTrain/BrainTrain_EEG_data/HEPs/heps_list_V1_eyes_closed-ave.fif', hep_list_eyes_closed, overwrite=True)
            elif task == 'eyes-open' and session == 'V1':
                mne.write_evokeds('/Users/denizyilmaz/Desktop/BrainTrain/BrainTrain_EEG_data/HEPs/heps_list_V1_eyes_open-ave.fif', hep_list_eyes_open, overwrite=True)
            elif task == 'hct' and session == 'V1':
                mne.write_evokeds('/Users/denizyilmaz/Desktop/BrainTrain/BrainTrain_EEG_data/HEPs/heps_list_V1_hct-ave.fif', hep_list_hct, overwrite=True)
            elif task == 'eyes-closed' and session == 'V3':
                mne.write_evokeds('/Users/denizyilmaz/Desktop/BrainTrain/BrainTrain_EEG_data/HEPs/heps_list_V3_eyes_closed-ave.fif', hep_list_eyes_closed, overwrite=True)
            elif task == 'eyes-open' and session == 'V3':
                mne.write_evokeds('/Users/denizyilmaz/Desktop/BrainTrain/BrainTrain_EEG_data/HEPs/heps_list_V3_eyes_open-ave.fif', hep_list_eyes_open, overwrite=True)
            elif task == 'hct' and session == 'V3':
                mne.write_evokeds('/Users/denizyilmaz/Desktop/BrainTrain/BrainTrain_EEG_data/HEPs/heps_list_V3_hct-ave.fif', hep_list_hct, overwrite=True)
           
            
            ### CSV : can be in or out of the loop
            
            # Construct the csv path
            csv_filename = 'hep_outputs_new.csv'
            csv_path = os.path.join('/Users/denizyilmaz/Desktop/BrainTrain/BrainTrain_EEG_data/HEPs',csv_filename)

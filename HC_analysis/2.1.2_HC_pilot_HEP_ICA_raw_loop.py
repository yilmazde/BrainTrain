...
column_names = ['subject_id', 'task', 'total_explained_var_ratio',
...
for participant_no in participant_numbers:
    for task in tasks: 
        ...
        file_path = os.path.join('/Users/denizyilmaz/Desktop/BrainTrain/Healthy Controls_BHC/BrainTrain_EEG_data_HC/HC_Preprocessed_ICA_applied_on_raw', ica_file_name)
        ...
        csv_filename = 'HC_ica_output_with_find-bads-ecg_raw_preprocessed.csv'
        csv_path = os.path.join('/Users/denizyilmaz/Desktop/BrainTrain/Healthy Controls_BHC/BrainTrain_EEG_data_HC/HC_Preprocessed_ICA_applied_on_raw',csv_filename)

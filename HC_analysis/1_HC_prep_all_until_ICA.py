...
# define excluded participants
excluded_participants = ['008']
...
for participant_index, participant_no in enumerate(participant_numbers):
    ...
    for task in tasks: 
        ...
        folder_name = 'HC_Preprocessed_until_ICA' 
        ...
        csv_filename = 'HC_prep_interp_output_bads_corr_dev.csv'    # or  'prep_interp_output'

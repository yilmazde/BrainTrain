...
prep_dir = '/Users/denizyilmaz/Desktop/BrainTrain/Healthy Controls_BHC/BrainTrain_EEG_data_HC/HC_Preprocessed_until_ICA'
os.chdir(prep_dir)
...
for participant_no in participant_numbers:
    for task in tasks: 
        ...
        # Save all Evokeds
        if task == 'eyes-closed' :
            mne.write_evokeds('/Users/denizyilmaz/Desktop/BrainTrain/Healthy Controls_BHC/BrainTrain_EEG_data_HC/ECG/ecgs_list_V1_eyes_closed-ave.fif', ecg_list_eyes_closed, overwrite=True)
        elif task == 'eyes-open' :
            mne.write_evokeds('/Users/denizyilmaz/Desktop/BrainTrain/Healthy Controls_BHC/BrainTrain_EEG_data_HC/ECG/ecgs_list_V1_eyes_open-ave.fif', ecg_list_eyes_open, overwrite=True)
        elif task == 'hct' :
            mne.write_evokeds('/Users/denizyilmaz/Desktop/BrainTrain/Healthy Controls_BHC/BrainTrain_EEG_data_HC/ECG/ecgs_list_V1_hct-ave.fif', ecg_list_hct, overwrite=True)
 
        
        ### CSV : can be in or out of the loop
        
        # Construct the csv path
        csv_filename = 'ecg_outputs_HC.csv'
        csv_path = os.path.join('/Users/denizyilmaz/Desktop/BrainTrain/Healthy Controls_BHC/BrainTrain_EEG_data_HC/ECG/',csv_filename)

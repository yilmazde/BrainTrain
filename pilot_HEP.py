...
raw = mne.io.read_raw("BTSCZ005_V3_hct.vhdr", preload=True)
...
"""
# first run an algoritm to detect bads: check the inbuilt function = mne.preprocessing.find_bad_channels_maxwell
...
# %% Creating ECG epochs: mne.preprocessing.create_ecg_epochs
